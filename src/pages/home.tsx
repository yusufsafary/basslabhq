    ...
    <div className="w-full">
      ...
      <section className="relative w-full" style={{ height: '100vh', minHeight: 600 }}>
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-8 md:px-16 lg:px-20 max-w-3xl">
          ...
          <motion.div initial={{ opacity:0, y:14 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.5, delay:0.35 }}
            ...
            <Link href="/generator">
              <button className="px-9 py-4 bg-amber-500 hover:bg-amber-400 text-black font-bold font-mono tracking-widest text-sm transition-all duration-200 shadow-xl shadow-amber-500/25">
                LAUNCH GENERATOR →
              </button>
            </Link>
            <Link href="/how-to">
              <button className="px-9 py-4 border border-white/20 hover:border-teal-400/50 text-slate-300 hover:text-teal-400 font-bold font-mono tracking-widest text-sm transition-all duration-200 bg-black/20 backdrop-blur-sm">
                HOW IT WORKS
              </button>
            </Link>
          </motion.div>
          ...
          <motion.div initial={{ opacity:0 }} animate={{ opacity:1 }} transition={{ duration:0.6, delay:0.5 }}
            ...
            {[['12+','Lakes'],['500+','Loadouts'],['97%','Accuracy'],['Free','Forever']].map(([v,l]) => (
              <div key={l}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {features.map((f, i) => (
              <motion.div key={i}
                ...
                className="group p-7 bg-white/[0.028] border border-white/[0.07] hover:border-amber-500/30 transition-all duration-300 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div key={i}
                ...
                className="text-center p-8 border border-white/6 bg-white/[0.02] relative">
      ...
      <section className="py-28 bg-[#07111f] border-t border-white/5 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <Link href="/generator">
            <button className="px-14 py-5 bg-amber-500 hover:bg-amber-400 text-black font-bold font-mono tracking-widest text-base transition-all duration-200 shadow-2xl shadow-amber-500/20">
              LAUNCH GENERATOR →
            </button>
          </Link>
        </div>
